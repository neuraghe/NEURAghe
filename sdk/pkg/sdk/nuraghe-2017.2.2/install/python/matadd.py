...
class plp_matadd_u8(Matadd):
  name = 'plp_matadd_u8'
  def __init__(self, params, args):
    super(plp_matadd_u8, self).__init__(params, args)
    self.setParams(word=8, xsign=0, ysign=0)

class plp_matadd_i8(Matadd):
  name = 'plp_matadd_i8'
  def __init__(self, params, args):
    super(plp_matadd_i8, self).__init__(params, args)
    self.setParams(word=8, xsign=1, ysign=1)

class plp_matadd_u16(Matadd):
  name = 'plp_matadd_u16'
  def __init__(self, params, args):
    super(plp_matadd_u16, self).__init__(params, args)
    self.setParams(word=16, xsign=0, ysign=0)

class plp_matadd_i16(Matadd):
  name = 'plp_matadd_i16'
  def __init__(self, params, args):
    super(plp_matadd_i16, self).__init__(params, args)
    self.setParams(word=16, xsign=1, ysign=1)

class plp_matadd_u32(Matadd):
  name = 'plp_matadd_u32'
  def __init__(self, params, args):
    super(plp_matadd_u32, self).__init__(params, args)
    self.setParams(word=32, xsign=0, ysign=0)

class plp_matadd_i32(Matadd):
  name = 'plp_matadd_i32'
  def __init__(self, params, args):
    super(plp_matadd_i32, self).__init__(params, args)
    self.setParams(word=32, xsign=1, ysign=1)
