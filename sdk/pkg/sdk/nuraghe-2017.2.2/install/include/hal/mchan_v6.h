 ...
 * 
  ...
  \return       The identifier of the transfer. This can be used with plp_dma_wait to wait for the completion of this transfer.
  */
static inline int plp_dma_l1ToExt_irq(unsigned int ext, unsigned int loc, unsigned short size);
 ...
 * 
  ...
  \return       The identifier of the transfer. This can be used with plp_dma_wait to wait for the completion of this transfer.
  */
static inline int plp_dma_extToL1_irq(unsigned int loc, unsigned int ext, unsigned short size);
 ...
 * 
  ...
  \return         The identifier of the transfer. This can be used with plp_dma_wait to wait for the completion of this transfer.
  */
static inline int plp_dma_memcpy_2d_irq(unsigned int ext, unsigned int loc, unsigned short size, unsigned short stride, unsigned short length, int ext2loc);
 ...
 * 
  ...
  \return         The identifier of the transfer. This can be used with plp_dma_wait to wait for the completion of this transfer.
  */
static inline int plp_dma_l1ToExt_2d_irq(unsigned int ext, unsigned int loc, unsigned short size, unsigned short stride, unsigned short length);
 ...
 * 
  ...
  \return         The identifier of the transfer. This can be used with plp_dma_wait to wait for the completion of this transfer
  */
static inline int plp_dma_extToL1_2d_irq(unsigned int loc, unsigned int ext, unsigned short size, unsigned short stride, unsigned short length);
...
#ifdef __riscv__
#define DMA_WRITE(value, offset) __builtin_pulp_OffsetedWrite((value), (int *)DEMUX_PERIPHERALS_BASE_ADDR, MCHAN_BASE_OFFSET + (offset))
#define DMA_READ(offset) __builtin_pulp_OffsetedRead((int *)DEMUX_PERIPHERALS_BASE_ADDR, MCHAN_BASE_OFFSET + (offset))
#else
#define DMA_WRITE(value, offset) pulp_write32(MCHAN_BASE_ADDR + (offset), (value))
#define DMA_READ(offset) pulp_read32(MCHAN_BASE_ADDR + (offset))
#endif
...
static inline void plp_dma_memcpy_2d_keepCounter(unsigned int ext, unsigned int loc, unsigned short size, unsigned short stride, unsigned short length, int ext2loc) {
...
static inline void plp_dma_barrier() {
  while(DMA_READ(PLP_DMA_STATUS_OFFSET) & 0xFFFF) {
    eu_evt_maskWaitAndClr(1<<PULP_DMA_EVT);
  }
