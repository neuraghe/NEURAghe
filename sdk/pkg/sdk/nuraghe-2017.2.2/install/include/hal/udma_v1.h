...
{
  pulp_write32(UDMA_BASE_ADDR + UDMA_CONF_OFFSET + UDMA_EVENTS_SETUP0_OFFSET, (inEvent0 << 0) | (inEvent1 << 4) | (inEvent2 << 8) | (inEvent3 << 12) | (inEvent4 << 16) | (inEvent5 << 20) | (inEvent6 << 24) | (inEvent7 << 28));
}
...
{
  pulp_write32(UDMA_BASE_ADDR + UDMA_CONF_OFFSET + UDMA_EVENTS_SETUP1_OFFSET, (inEvent0 << 0) | (inEvent1 << 4) | (inEvent2 << 8) | (inEvent3 << 12) | (inEvent4 << 16) | (inEvent5 << 20) | (inEvent6 << 24) | (inEvent7 << 28));
}
