...
#else
#define NUM_THDS 4	/* Select your configuration*/
#endif
/* Define the segmentation temporary buffer for each thread */
#define TEMP_SEG_BUFFER 50
/* Defined if you want profile the SLIC library */
//#define PROFILING_LIB
/* Defined if you want evaluate the checksums */
#define CHECKSUMS
/* Defined if you want enable Performance Counters */
//#define PERF_COUNTERS
/* Defined if you want silent prints */
//#define SILENT
