...
/* For other core versions compatibility */
#define SPR_PCCR(N)	0
#define SPR_PCER	0
#define SPR_PCMR	0
#define SPR_PCER_CYCLES		0
#define SPR_PCER_INSTR		0
#define SPR_PCER_LD_STALL	0
#define SPR_PCER_JMP_STALL	0
#define SPR_PCER_IMISS		0
#define SPR_PCER_WBRANCH	0
#define SPR_PCER_WBRANCH_CYC	0
#define SPR_PCER_LD		0
#define SPR_PCER_ST		0
#define SPR_PCER_JUMP	        0
#define SPR_PCER_BRANCH		0
#define SPR_PCER_DELAY_NOP	0
#define SPR_PCER_LD_EXT		0
#define SPR_PCER_ST_EXT		0
#define SPR_PCER_LD_EXT_CYC	0
#define SPR_PCER_ST_EXT_CYC	0
#define SPR_PCER_TCDM_CONT	0
#define SPR_PCER_NB_EVENTS      0
#define SPR_PCER_ALL_EVENTS_MASK  0
#define SPR_PCMR_ACTIVE           0
#define SPR_PCMR_SATURATE         0
