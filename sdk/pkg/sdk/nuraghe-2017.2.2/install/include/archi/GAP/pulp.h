...
#if !defined(PULP_CHIP) || PULP_CHIP != CHIP_GAP
#error This file must be included only for GAP chip
#endif
...
#define FC_TCDM_CORE_START            PULP_FC_REMOTE_BASE
#define FC_TCDM_APB_MAPPED_START      0x1B308000
