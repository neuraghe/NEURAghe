#ifndef NURAGHE_PULP_H
#define NURAGHE_PULP_H

#if PULP_CHIP != CHIP_NURAGHE
#error This file must be included only for nuraghe chip
#endif
...
#define TCDM_SRAM_BASE_ADDR           ( TCDM_BASE_ADDR + 0xF8000 )
#define TCDM_SCM_BASE_ADDR            ( TCDM_BASE_ADDR + 0x0 )
#define TEST_AND_SET_OFFSET           0x00100000
#define TEST_AND_SET_BASE_ADDR        ( PULP_BASE_ADDR + TEST_AND_SET_OFFSET )
#define LIBGOMP_BASE_ADDR             ( TCDM_SRAM_BASE_ADDR )
