...
START_RELOC_NUMBERS (elf_or1k_reloc_type)
  ...
  RELOC_NUMBER (R_OR1K_4_PCREL,       32)
  RELOC_NUMBER (R_OR1K_12_PCREL,      33)
  RELOC_NUMBER (R_OR1K_SPLIT_LO16,    34)
  RELOC_NUMBER (R_OR1K_SPLIT_HI16,    35)
  RELOC_NUMBER (R_OR1K_SPLIT_16ADDR,  36)
  RELOC_NUMBER (R_OR1K_TLS_TPOFF,     37)
  RELOC_NUMBER (R_OR1K_TLS_DTPOFF,    38)
  RELOC_NUMBER (R_OR1K_TLS_DTPMOD,    39)
  RELOC_NUMBER (R_OR1K_DISP21,	      40)
  RELOC_NUMBER (R_OR1K_DISPU16,	      41)
  RELOC_NUMBER (R_OR1K_DISPU8,	      42)
