...
src="371e1d8eff2c424bd9c707b2dad57daacfd85a8f"
artefacts=[["https://iis-artifactory.ee.ethz.ch/artifactory/release/Ubuntu_14/pulp/sdk/mainstream/acf7e65c3f1c0b006a67cc4df43b9de3600b00f1/0/sdk.tar.bz2", "pkg/sdk/2016.12.3"], ["https://iis-artifactory.ee.ethz.ch/artifactory/release/Ubuntu_14/pulp/or1k_gcc/mainstream/1.2.7/0/or1k_gcc.tar.bz2", "pkg/or1k_gcc/1.2.7"], ["https://iis-artifactory.ee.ethz.ch/artifactory/release/Ubuntu_14/pulp/or10nv2_gcc/mainstream/2.0.12/0/or10nv2_gcc.tar.bz2", "pkg/or10nv2_gcc/2.0.12"], ["https://iis-artifactory.ee.ethz.ch/artifactory/release/Ubuntu_14/pulp/riscv_gcc/mainstream/2.3.2/0/riscv_gcc.tar.bz2", "pkg/riscv_gcc/2.3.2"]]
envFileStrCsh=["setenv OR1K_GCC_TOOLCHAIN @PULP_PKG_HOME@/pkg/or1k_gcc/1.2.7", "setenv OR10NV2_GCC_TOOLCHAIN @PULP_PKG_HOME@/pkg/or10nv2_gcc/2.0.12", "setenv RISCV_GCC_VERSION 2.3.2", "setenv RISCV_GCC_TOOLCHAIN @PULP_PKG_HOME@/pkg/riscv_gcc/2.3.2", "setenv PULP_SDK_HOME @PULP_PKG_HOME@/pkg/sdk/2016.12.3", "if ( -e @PULP_PKG_HOME@/pkg/sdk/2016.12.3/setup.csh ) source @PULP_PKG_HOME@/pkg/sdk/2016.12.3/setup.csh", ""]
envFileStr=["export OR1K_GCC_TOOLCHAIN=@PULP_PKG_HOME@/pkg/or1k_gcc/1.2.7", "export OR10NV2_GCC_TOOLCHAIN=@PULP_PKG_HOME@/pkg/or10nv2_gcc/2.0.12", "export RISCV_GCC_VERSION=2.3.2", "export RISCV_GCC_TOOLCHAIN=@PULP_PKG_HOME@/pkg/riscv_gcc/2.3.2", "export PULP_SDK_HOME=@PULP_PKG_HOME@/pkg/sdk/2016.12.3", "if [ -e @PULP_PKG_HOME@/pkg/sdk/2016.12.3/setup.sh ]; then . @PULP_PKG_HOME@/pkg/sdk/2016.12.3/setup.sh; fi", ""]
pkg=["sdk", "2016.12.3"]
