...
src="fc8131367d18fe3bb476a5b3a021431858b163f8"
artefacts=[["https://iis-artifactory.ee.ethz.ch/artifactory/release/Ubuntu_16/pulp/sdk/mainstream/b90e299d3b0f23950d2fd7180b0f647bfe1baefb/0/sdk.tar.bz2", "pkg/sdk/nuraghe-2017.2.2"], ["https://iis-artifactory.ee.ethz.ch/artifactory/release/Ubuntu_16/pulp/or1k_gcc/mainstream/1.2.7/0/or1k_gcc.tar.bz2", "pkg/or1k_gcc/1.2.7"], ["https://iis-artifactory.ee.ethz.ch/artifactory/release/Ubuntu_16/pulp/or10nv2_gcc/mainstream/2.0.12/0/or10nv2_gcc.tar.bz2", "pkg/or10nv2_gcc/2.0.12"], ["https://iis-artifactory.ee.ethz.ch/artifactory/release/Ubuntu_16/pulp/riscv_gcc/mainstream/2.3.2/0/riscv_gcc.tar.bz2", "pkg/riscv_gcc/2.3.2"]]
envFileStrCsh=["setenv OR1K_GCC_TOOLCHAIN @PULP_PKG_HOME@/pkg/or1k_gcc/1.2.7", "setenv OR10NV2_GCC_TOOLCHAIN @PULP_PKG_HOME@/pkg/or10nv2_gcc/2.0.12", "setenv RISCV_GCC_VERSION 2.3.2", "setenv RISCV_GCC_TOOLCHAIN @PULP_PKG_HOME@/pkg/riscv_gcc/2.3.2", "setenv PULP_SDK_HOME @PULP_PKG_HOME@/pkg/sdk/nuraghe-2017.2.2", "if ( -e @PULP_PKG_HOME@/pkg/sdk/nuraghe-2017.2.2/setup.csh ) source @PULP_PKG_HOME@/pkg/sdk/nuraghe-2017.2.2/setup.csh", ""]
envFileStr=["export OR1K_GCC_TOOLCHAIN=@PULP_PKG_HOME@/pkg/or1k_gcc/1.2.7", "export OR10NV2_GCC_TOOLCHAIN=@PULP_PKG_HOME@/pkg/or10nv2_gcc/2.0.12", "export RISCV_GCC_VERSION=2.3.2", "export RISCV_GCC_TOOLCHAIN=@PULP_PKG_HOME@/pkg/riscv_gcc/2.3.2", "export PULP_SDK_HOME=@PULP_PKG_HOME@/pkg/sdk/nuraghe-2017.2.2", "if [ -e @PULP_PKG_HOME@/pkg/sdk/nuraghe-2017.2.2/setup.sh ]; then . @PULP_PKG_HOME@/pkg/sdk/nuraghe-2017.2.2/setup.sh; fi", ""]
pkg=["sdk", "nuraghe-2017.2.2"]
