...
CONFIG.USE_LOCKED {true} \
  ...
  set nuraghe_soc_1 [ create_bd_cell -type ip -vlnv uniCA:user:nuraghe_soc:4.0 nuraghe_soc_1 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {2} \
CONFIG.NUM_WRITE_OUTSTANDING {2} \
 ] [get_bd_intf_pins /nuraghe_soc_1/DATA_IN_S]
...
CONFIG.MAX_BURST_LENGTH {256} \
 ] [get_bd_intf_pins /nuraghe_soc_1/DATA_OUT_M]
...
CONFIG.NUM_WRITE_OUTSTANDING {2} \
CONFIG.MAX_BURST_LENGTH {256} \
 ] [get_bd_intf_pins /nuraghe_soc_1/DMA_TO_DDR_M]
...
CONFIG.NUM_WRITE_OUTSTANDING {2} \
CONFIG.MAX_BURST_LENGTH {256} \
 ] [get_bd_intf_pins /nuraghe_soc_1/STDOUT_M]
...
CONFIG.NUM_WRITE_OUTSTANDING {2} \
CONFIG.MAX_BURST_LENGTH {256} \
 ] [get_bd_intf_pins /nuraghe_soc_1/WEI_TO_DDR0]
...
CONFIG.NUM_WRITE_OUTSTANDING {2} \
CONFIG.MAX_BURST_LENGTH {256} \
 ] [get_bd_intf_pins /nuraghe_soc_1/WEI_TO_DDR1]
...
CONFIG.C_S00_AXI_ID_WIDTH {12} \
  ...
  connect_bd_intf_net -intf_net axi_protocol_converter_2_M_AXI1 [get_bd_intf_pins axi_protocol_converter_4/M_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP3]
  ...
  connect_bd_intf_net -intf_net nuraghe_soc_1_DATA_OUT_M [get_bd_intf_pins axi_protocol_converter_0/S_AXI] [get_bd_intf_pins nuraghe_soc_1/DATA_OUT_M]
  connect_bd_intf_net -intf_net nuraghe_soc_1_DMA_TO_DDR_M [get_bd_intf_pins axi_protocol_converter_3/S_AXI] [get_bd_intf_pins nuraghe_soc_1/DMA_TO_DDR_M]
  connect_bd_intf_net -intf_net nuraghe_soc_1_STDOUT_M [get_bd_intf_pins axi_protocol_converter_1/S_AXI] [get_bd_intf_pins nuraghe_soc_1/STDOUT_M]
  connect_bd_intf_net -intf_net nuraghe_soc_1_WEI_TO_DDR0 [get_bd_intf_pins axi_protocol_converter_2/S_AXI] [get_bd_intf_pins nuraghe_soc_1/WEI_TO_DDR0]
  connect_bd_intf_net -intf_net nuraghe_soc_1_WEI_TO_DDR1 [get_bd_intf_pins axi_protocol_converter_4/S_AXI] [get_bd_intf_pins nuraghe_soc_1/WEI_TO_DDR1]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins nuraghe_soc_1/DATA_IN_S] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net clk_wiz_1_clk_out2 [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins nuraghe_soc_1/clk_cluster_fast_i]
  connect_bd_net -net clk_wiz_1_clk_out3 [get_bd_pins axi_protocol_converter_2/aclk] [get_bd_pins axi_protocol_converter_4/aclk] [get_bd_pins clk_wiz_1/clk_out3] [get_bd_pins nuraghe_soc_1/clk_wmem_i] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP3_ACLK]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins rst_processing_system7_0_50M/dcm_locked]
  connect_bd_net -net nuraghe_soc_1_eoc_o [get_bd_pins nuraghe_soc_1/eoc_o] [get_bd_pins soc_AXI_ctrl_v1_0_0/eoc_i]
  connect_bd_net -net nuraghe_soc_1_return_o [get_bd_pins nuraghe_soc_1/return_o] [get_bd_pins soc_AXI_ctrl_v1_0_0/return_i]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dwidth_converter_0/s_axi_aclk] [get_bd_pins axi_protocol_converter_0/aclk] [get_bd_pins axi_protocol_converter_1/aclk] [get_bd_pins axi_protocol_converter_3/aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins nuraghe_soc_1/clk_soc_i] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_50M/slowest_sync_clk] [get_bd_pins soc_AXI_ctrl_v1_0_0/s00_axi_aclk]
  ...
  connect_bd_net -net rst_processing_system7_0_50M_peripheral_aresetn [get_bd_pins axi_dwidth_converter_0/s_axi_aresetn] [get_bd_pins axi_protocol_converter_0/aresetn] [get_bd_pins axi_protocol_converter_1/aresetn] [get_bd_pins axi_protocol_converter_2/aresetn] [get_bd_pins axi_protocol_converter_3/aresetn] [get_bd_pins axi_protocol_converter_4/aresetn] [get_bd_pins nuraghe_soc_1/rstn_sync_i] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_50M/peripheral_aresetn] [get_bd_pins soc_AXI_ctrl_v1_0_0/s00_axi_aresetn]
  connect_bd_net -net soc_AXI_ctrl_v1_0_0_fech_enable_o [get_bd_ports fech_enable_o] [get_bd_pins nuraghe_soc_1/fetch_en_i] [get_bd_pins soc_AXI_ctrl_v1_0_0/fech_enable_o]
  connect_bd_net -net soc_AXI_ctrl_v1_0_0_mode_select_o [get_bd_pins nuraghe_soc_1/mode_select_i] [get_bd_pins soc_AXI_ctrl_v1_0_0/mode_select_o]
  connect_bd_net -net soc_AXI_ctrl_v1_0_0_test_mode_o [get_bd_pins nuraghe_soc_1/test_mode_i] [get_bd_pins soc_AXI_ctrl_v1_0_0/test_mode_o]

  # Create address segments
  create_bd_addr_seg -range 0x10000000 -offset 0x50000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs nuraghe_soc_1/DATA_IN_S/Reg] SEG_nuraghe_soc_1_Reg
