...
//#include "./pl_tests/conv_hwce_l2.h"
//#include "../pl_tests/helloworld_l2.h"
//#include "../pl_tests/stdout_l2.h"
//#include "../pl_tests/dma_transfert_l2.h"
//#include "../pl_tests/power_test_l2.h"
...
void load_code (volatile int * soc_addr){
	/* Loads into L2 memory the test code.
	 *
	 * The function reads the array l2_code and writes its content into L2 through the Zynq - PL AXI interconnect.
	 * le_code array must be defined into the header file specific for each test. See the top of this file.
	 */
...
void wait_for (long int num){
  /* Wait for a while. The time depends on ARM working frequency and on the number of instructions used to implement for statement.
   * */
	for (;num>0;num--);
}
