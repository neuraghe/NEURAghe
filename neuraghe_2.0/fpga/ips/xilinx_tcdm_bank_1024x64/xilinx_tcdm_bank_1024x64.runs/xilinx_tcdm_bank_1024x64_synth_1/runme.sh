...
HD_PWD='/home/gderiu/gianfranco/neuraghe_wei2ddr_fast_nolic/fpga/ips/xilinx_tcdm_bank_1024x64/xilinx_tcdm_bank_1024x64.runs/xilinx_tcdm_bank_1024x64_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xilinx_tcdm_bank_1024x64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xilinx_tcdm_bank_1024x64.tcl
