...
HD_PWD='/home/nur/neuraghe_2.0/neuraghe_2.0/fpga/soc/soc.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log ulpsoc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ulpsoc.tcl
