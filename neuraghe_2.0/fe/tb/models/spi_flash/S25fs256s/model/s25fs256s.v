...
///////////////////////////////////////////////////////////////////////////////
    ...
    parameter otp_file_name     = "none";//"s25fs256sOTP.mem";//
    ...
    parameter  SFDPHiAddr       = 16'h10BF;
    parameter  SFDPLength       = 16'h10BF;
    parameter  CFILength        = 8'h50;
    parameter  BYTE             = 8;
...
//    /////////////////////////////////////////////////////////////////////////
    ...
    always @(posedge change_PageSize)
    begin
        if (CR3_V[4] == 1'b0)
        begin
            PageSize = 255;
