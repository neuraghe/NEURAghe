  ...
  begin
    ...
    fork
          ...
          begin
            ...
            if (count_local_W % 2)     local_be = 8'b11110000; else   local_be = 8'b00001111;
...
input  logic [15:0]  transfer_count;
input  string        transfer_type;
input  logic [63:0]  check_pattern;
