...
module fetch_buffer_256
#(
    parameter                                                    NUM_WORDS = 16  // do not edit
)
(
    input logic                                                  clk,
    input logic                                                  rst_n,
    ...
    assign fetch_hit = (instr_add_i[31:6] == tag_array) ? 1'b1 : 1'b0; 
    
    always_comb
    begin
    
      instr_req_o      = 1'b0;
      instr_add_o      = {instr_add_i[31:5],6'b00_0000};
