...
module fetch_buffer_64
#(
    parameter                                                   NUM_WORDS = 2  // do not edit
)
(
    input logic                                                 clk,
    input logic                                                 rst_n,
    ...
    assign fetch_hit = (instr_add_i[31:3] == tag_array) ? 1'b1 : 1'b0;
