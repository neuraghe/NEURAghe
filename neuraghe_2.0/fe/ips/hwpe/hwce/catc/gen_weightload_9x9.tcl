...
solution file add ./weight_loader_9x9.c
...
go analyze
directive set -DESIGN_HIERARCHY weight_loader_9x9
go compile
directive set /weight_loader_9x9 -EFFORT_LEVEL high
directive set /weight_loader_9x9/core/main/for -PIPELINE_INIT_INTERVAL 1
directive set /weight_loader_9x9/core/main/for -UNROLL 2
directive set /weight_loader_9x9/weight_tcdm:rsc -INTERLEAVE 2
directive set /weight_loader_9x9/weight_tcdm:rsc -MAP_TO_MODULE ram_w_handshake.ram_w_handshake
directive set /weight_loader_9x9/weight_priv:rsc -MAP_TO_MODULE mgc_ioport.mgc_out_stdreg
go allocate
go compile
go allocate
go extract