...
________________________________________________________________________________________________
            ...
            UMC 65nm Low-k Low Leakage Process 
...
module SYKA65_512X8X4CM4 (A,DO,DI,DVSE,DVS,WEB,CK,CSB);
  ...
  parameter  TOH                  = (29.5:43.0:76.6); 
  parameter  TWDX                 = (44.2:64.5:114.9);
...
/* -----\/----- EXCLUDED -----\/-----
   specify
      specparam TAA  = (65.8:106.8:195.6);
      specparam TWDV = (65.8:106.8:195.6);
      specparam TRC  = (88.4:129.1:229.7);
      specparam THPW = (12.6:19.1:33.9);
      specparam TLPW = (12.6:19.1:33.9);
      specparam TAS  = (6.1:10.9:21.8);
      specparam TAH  = (1.3:1.7:2.7);
      specparam TWS  = (3.9:7.4:17.1);
      specparam TWH  = (6.2:9.4:15.3);
      specparam TDS  = (6.3:11.6:25.8);
      specparam TDH  = (4.0:5.8:8.2);
      specparam TCSS = (12.6:19.8:35.6);
      specparam TCSH = (5.9:9.0:15.2);
