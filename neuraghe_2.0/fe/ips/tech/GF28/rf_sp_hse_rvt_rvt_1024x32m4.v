...
//
//       Instance Name:              rf_sp_hse_rvt_rvt_1024x32m4
//       Words:                      1024
//       Bits:                       32
//       Mux:                        4
//       Drive:                      6
...
//       
//       Creation Date:  Mon Oct  5 16:06:36 2015
//       Version: 	r5p1
//
...
module datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 (CLK,Q_update,D_update,SE,SI,D,DFTRAMBYP,mem_path,XQ,Q);
...
endmodule // datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4
...
`ifdef POWER_PINS
module rf_sp_hse_rvt_rvt_1024x32m4 (VDDCE, VDDPE, VSSE, CENY, WENY, AY, GWENY, Q, SO,
    CLK, CEN, WEN, A, D, EMA, EMAW, EMAS, TEN, TCEN, TWEN, TA, TD, GWEN, TGWEN, RET1N,
    SI, SE, DFTRAMBYP);
`else
module rf_sp_hse_rvt_rvt_1024x32m4 (CENY, WENY, AY, GWENY, Q, SO, CLK, CEN, WEN, A,
...
`endif
 ...
 wire  CLK_;
  ...
  assign `ARM_UD_DP AY_ = (RET1N_ | pre_charge_st) ? ({10{DFTRAMBYP_}} & (TEN_ ? A_ : TA_)) : {10{1'bx}};
...
`endif
  ...
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ0 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(SI_int[0]), .D(D_int_bmux[0]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[0]), .XQ(XQ), .Q(Q_int[0]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ1 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[0]), .D(D_int_bmux[1]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[1]), .XQ(XQ), .Q(Q_int[1]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ2 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[1]), .D(D_int_bmux[2]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[2]), .XQ(XQ), .Q(Q_int[2]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ3 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[2]), .D(D_int_bmux[3]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[3]), .XQ(XQ), .Q(Q_int[3]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ4 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[3]), .D(D_int_bmux[4]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[4]), .XQ(XQ), .Q(Q_int[4]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ5 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[4]), .D(D_int_bmux[5]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[5]), .XQ(XQ), .Q(Q_int[5]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ6 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[5]), .D(D_int_bmux[6]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[6]), .XQ(XQ), .Q(Q_int[6]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ7 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[6]), .D(D_int_bmux[7]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[7]), .XQ(XQ), .Q(Q_int[7]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ8 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[7]), .D(D_int_bmux[8]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[8]), .XQ(XQ), .Q(Q_int[8]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ9 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[8]), .D(D_int_bmux[9]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[9]), .XQ(XQ), .Q(Q_int[9]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ10 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[9]), .D(D_int_bmux[10]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[10]), .XQ(XQ), .Q(Q_int[10]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ11 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[10]), .D(D_int_bmux[11]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[11]), .XQ(XQ), .Q(Q_int[11]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ12 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[11]), .D(D_int_bmux[12]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[12]), .XQ(XQ), .Q(Q_int[12]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ13 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[12]), .D(D_int_bmux[13]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[13]), .XQ(XQ), .Q(Q_int[13]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ14 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[13]), .D(D_int_bmux[14]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[14]), .XQ(XQ), .Q(Q_int[14]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ15 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[14]), .D(D_int_bmux[15]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[15]), .XQ(XQ), .Q(Q_int[15]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ16 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[17]), .D(D_int_bmux[16]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[16]), .XQ(XQ), .Q(Q_int[16]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ17 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[18]), .D(D_int_bmux[17]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[17]), .XQ(XQ), .Q(Q_int[17]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ18 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[19]), .D(D_int_bmux[18]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[18]), .XQ(XQ), .Q(Q_int[18]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ19 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[20]), .D(D_int_bmux[19]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[19]), .XQ(XQ), .Q(Q_int[19]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ20 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[21]), .D(D_int_bmux[20]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[20]), .XQ(XQ), .Q(Q_int[20]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ21 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[22]), .D(D_int_bmux[21]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[21]), .XQ(XQ), .Q(Q_int[21]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ22 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[23]), .D(D_int_bmux[22]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[22]), .XQ(XQ), .Q(Q_int[22]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ23 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[24]), .D(D_int_bmux[23]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[23]), .XQ(XQ), .Q(Q_int[23]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ24 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[25]), .D(D_int_bmux[24]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[24]), .XQ(XQ), .Q(Q_int[24]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ25 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[26]), .D(D_int_bmux[25]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[25]), .XQ(XQ), .Q(Q_int[25]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ26 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[27]), .D(D_int_bmux[26]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[26]), .XQ(XQ), .Q(Q_int[26]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ27 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[28]), .D(D_int_bmux[27]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[27]), .XQ(XQ), .Q(Q_int[27]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ28 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[29]), .D(D_int_bmux[28]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[28]), .XQ(XQ), .Q(Q_int[28]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ29 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[30]), .D(D_int_bmux[29]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[29]), .XQ(XQ), .Q(Q_int[29]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ30 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[31]), .D(D_int_bmux[30]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[30]), .XQ(XQ), .Q(Q_int[30]));
  datapath_latch_rf_sp_hse_rvt_rvt_1024x32m4 uDQ31 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(SI_int[1]), .D(D_int_bmux[31]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[31]), .XQ(XQ), .Q(Q_int[31]));
...
`endif
  ...
  reg NOT_CEN, NOT_WEN3, NOT_WEN2, NOT_WEN1, NOT_WEN0, NOT_A9, NOT_A8, NOT_A7, NOT_A6;
  ...
  reg NOT_EMA2, NOT_EMA1, NOT_EMA0, NOT_EMAW1, NOT_EMAW0, NOT_EMAS, NOT_TEN, NOT_TCEN;
  reg NOT_TWEN3, NOT_TWEN2, NOT_TWEN1, NOT_TWEN0, NOT_TA9, NOT_TA8, NOT_TA7, NOT_TA6;
  reg NOT_TA5, NOT_TA4, NOT_TA3, NOT_TA2, NOT_TA1, NOT_TA0, NOT_TD31, NOT_TD30, NOT_TD29;
 ...
 wire  CLK_;
  ...
  buf B104(TEN_, TEN);
  buf B105(TCEN_, TCEN);
  buf B106(TWEN_[0], TWEN[0]);
  buf B107(TWEN_[1], TWEN[1]);
  buf B108(TWEN_[2], TWEN[2]);
  buf B109(TWEN_[3], TWEN[3]);
  buf B110(TA_[0], TA[0]);
  buf B111(TA_[1], TA[1]);
  buf B112(TA_[2], TA[2]);
  buf B113(TA_[3], TA[3]);
  ...
  buf B128(TD_[8], TD[8]);
  buf B129(TD_[9], TD[9]);
  buf B130(TD_[10], TD[10]);
  buf B131(TD_[11], TD[11]);
  buf B132(TD_[12], TD[12]);
  buf B133(TD_[13], TD[13]);
  buf B134(TD_[14], TD[14]);
  buf B135(TD_[15], TD[15]);
  buf B136(TD_[16], TD[16]);
  buf B137(TD_[17], TD[17]);
  buf B138(TD_[18], TD[18]);
  buf B139(TD_[19], TD[19]);
  buf B140(TD_[20], TD[20]);
  buf B141(TD_[21], TD[21]);
  buf B142(TD_[22], TD[22]);
  buf B143(TD_[23], TD[23]);
  buf B144(TD_[24], TD[24]);
  buf B145(TD_[25], TD[25]);
  buf B146(TD_[26], TD[26]);
  buf B147(TD_[27], TD[27]);
  buf B148(TD_[28], TD[28]);
  buf B149(TD_[29], TD[29]);
  buf B150(TD_[30], TD[30]);
  buf B151(TD_[31], TD[31]);
  buf B152(GWEN_, GWEN);
  buf B153(TGWEN_, TGWEN);
  buf B154(RET1N_, RET1N);
  buf B155(SI_[0], SI[0]);
  buf B156(SI_[1], SI[1]);
  buf B157(SE_, SE);
  buf B158(DFTRAMBYP_, DFTRAMBYP);
  ...
  assign AY_ = (RET1N_ | pre_charge_st) ? ({10{DFTRAMBYP_}} & (TEN_ ? A_ : TA_)) : {10{1'bx}};
...
`endif
 ...
 wire  CLK_;
  ...
  buf B159(CENY, CENY_);
  buf B160(WENY[0], WENY_[0]);
  buf B161(WENY[1], WENY_[1]);
  buf B162(WENY[2], WENY_[2]);
  buf B163(WENY[3], WENY_[3]);
  buf B164(AY[0], AY_[0]);
  buf B165(AY[1], AY_[1]);
  buf B166(AY[2], AY_[2]);
  buf B167(AY[3], AY_[3]);
  ...
  buf B209(CLK_, CLK);
  buf B210(CEN_, CEN);
  buf B211(WEN_[0], WEN[0]);
  buf B212(WEN_[1], WEN[1]);
  buf B213(WEN_[2], WEN[2]);
  buf B214(WEN_[3], WEN[3]);
  buf B215(A_[0], A[0]);
  buf B216(A_[1], A[1]);
  buf B217(A_[2], A[2]);
  buf B218(A_[3], A[3]);
  ...
  buf B263(TEN_, TEN);
  buf B264(TCEN_, TCEN);
  buf B265(TWEN_[0], TWEN[0]);
  buf B266(TWEN_[1], TWEN[1]);
  buf B267(TWEN_[2], TWEN[2]);
  buf B268(TWEN_[3], TWEN[3]);
  buf B269(TA_[0], TA[0]);
  buf B270(TA_[1], TA[1]);
  buf B271(TA_[2], TA[2]);
  buf B272(TA_[3], TA[3]);
  ...
  buf B311(GWEN_, GWEN);
  buf B312(TGWEN_, TGWEN);
  buf B313(RET1N_, RET1N);
  buf B314(SI_[0], SI[0]);
  buf B315(SI_[1], SI[1]);
  buf B316(SE_, SE);
  buf B317(DFTRAMBYP_, DFTRAMBYP);
  ...
  assign GWENY_ = (RET1N_ | pre_charge_st) ? (DFTRAMBYP_ & (TEN_ ? GWEN_ : TGWEN_)) : 1'bx;
   `ifdef ARM_FAULT_MODELING
     rf_sp_hse_rvt_rvt_1024x32m4_error_injection u1(.CLK(CLK_), .Q_out(Q_), .A(A_int), .CEN(CEN_int), .DFTRAMBYP(DFTRAMBYP_int), .SE(SE_int), .GWEN(GWEN_int), .WEN(WEN_int), .Q_in(Q_int));
  `else
  assign Q_ = (RET1N_ | pre_charge_st) ? ((Q_int)) : {32{1'bx}};
  `endif
  assign SO_ = (RET1N_ | pre_charge_st) ? ({Q_[16], Q_[15]}) : {2{1'bx}};
...
`endif
`timescale 1ns/1ps
module rf_sp_hse_rvt_rvt_1024x32m4_error_injection (Q_out, Q_in, CLK, A, CEN, DFTRAMBYP, SE, WEN, GWEN);
   output [31:0] Q_out;
   input [31:0] Q_in;
   input CLK;
   input [9:0] A;
...
begin
   ...
   `ifdef ARM_NONREPAIRABLE_FAULT
      `pre_pend_path.SMARCHCHKBVCD_LVISION_MBISTPG_ASSEMBLY_UNDER_TEST_INST.MEM0_MEM_INST.u1.add_fault(10'd754,5'd6,2'd1,2'd0);
   `endif
end
   task add_fault;
