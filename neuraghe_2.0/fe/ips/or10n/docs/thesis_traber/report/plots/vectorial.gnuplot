...
set yrange [ 0.00000 : 13. ] noreverse nowriteback

plot 'vectorial.csv' using 2:xtic(1) ti col, '' u 3 ti col, '' u 4 ti col, '' u 5 ti col, '' u 6 ti col, '' u 7 ti col
