...
def dispose_weights_5x5 (w_disp, offset, w_lin, bias):
  ...
  for i in range ((FS*FS)+1, _WS_SIZE_):
    w_disp[offset+i]= 0;
  return
    ...
    if o<OF:
      for i in range (0, if_round):
        if i<IF:
          ...
          dispose_weights_5x5 (w_disp, (o*if_round + i)*_WS_SIZE_, w[(o*IF + i)*(FS*FS):], b[o])
        else:
...
#      print_pb(o, of_round)
#      if o<OF:
#        for i in range ( 0, if_round/(NCOL*3)):
#          for k in range (0, 3):
#            for j in range(0, NCOL):
#              for www in range (0, 9):
#                if i*(NCOL*3)+k*NCOL+j<IF:
#                  w_disp[ o*if_round/(NCOL*3)*NCOL*_WS_SIZE_ + i*NCOL*_WS_SIZE_ + j*_WS_SIZE_ + k*9 +www] = w[o*IF*9 + i*3*NCOL*9 + k*NCOL*9 + j*9 + www]
#                else:
#                  w_disp[ o*if_round/(NCOL*3)*NCOL*_WS_SIZE_ + i*NCOL*_WS_SIZE_ + j*_WS_SIZE_ + k*9 +www] =0
#      else:
#        for www in range (0, _WS_SIZE_*NCOL*if_round/(NCOL*3)):
#          w_disp[ o*if_round/(NCOL*3)*NCOL*_WS_SIZE_ +www] = 0
#      
#    #ADDING BIASES
#    for o in range (0, of_round):
#      for i in range (0, if_round/3):
#        if o<OF:
#          w_disp[o*if_round/3*_WS_SIZE_ + i*_WS_SIZE_ + _BIAS_POS_] = b[o];
#        else:        
#          w_disp[o*if_round/3*_WS_SIZE_ + i*_WS_SIZE_ + _BIAS_POS_] = 0;
