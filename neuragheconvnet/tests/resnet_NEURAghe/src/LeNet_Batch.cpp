...
if (_NCOL_ == 2)
   minmaxog=9;
	...
	scale2_block0_A_conv2d_param->maxog = 8;
	scale2_block0_B_conv2d_param->maxog = 8;
	scale2_block1_A_conv2d_param->maxog = 8;
	scale2_block1_B_conv2d_param->maxog = 8;
	
	scale3_block0_shortcut_conv2d_param->maxog = 8;
	scale3_block0_A_conv2d_param->maxog = 8;
	scale3_block0_B_conv2d_param->maxog = 8;
	scale3_block1_A_conv2d_param->maxog = 8;
	scale3_block1_B_conv2d_param->maxog = 8;
	
	scale4_block0_shortcut_conv2d_param->maxog = 8;
	scale4_block0_A_conv2d_param->maxog = 8;
	scale4_block0_B_conv2d_param->maxog = 8;
	scale4_block1_A_conv2d_param->maxog = 30;
	scale4_block1_B_conv2d_param->maxog = 30;
	
	scale5_block0_shortcut_conv2d_param->maxog = 30;
	scale5_block0_A_conv2d_param->maxog = 30;
	scale5_block0_B_conv2d_param->maxog = 30;
	scale5_block1_A_conv2d_param->maxog = 30;
	scale5_block1_B_conv2d_param->maxog = 30;
...
*/  
	...
	conv_id[0] = spatconv_forward_hw(scale1_conv2d_5x5_0_param, soc->in, scale1_conv2d_5x5_0_out, soc, scale1_conv2d_padding_size, scale1_conv2d_5x5_out, scale1_conv2d_merge_stride, scale1_conv2d_merge_pad, false, _QF_, PRECISION8);        
	conv_id[1] = spatconv_forward_hw(scale1_conv2d_5x5_1_param, soc->in, scale1_conv2d_5x5_1_out, soc, scale1_conv2d_padding_size, scale1_conv2d_5x5_out, scale1_conv2d_merge_stride, scale1_conv2d_merge_pad, false, _QF_, PRECISION8);
	conv_id[2] = spatconv_forward_hw(scale1_conv2d_5x5_2_param, soc->in, scale1_conv2d_5x5_2_out, soc, scale1_conv2d_padding_size, scale1_conv2d_5x5_out, scale1_conv2d_merge_stride, scale1_conv2d_merge_pad, false, _QF_, PRECISION8);
	conv_id[3] = spatconv_forward_hw(scale1_conv2d_5x5_3_param, soc->in, scale1_conv2d_5x5_3_out, soc, scale1_conv2d_padding_size, scale1_conv2d_5x5_out, scale1_conv2d_merge_stride, scale1_conv2d_merge_pad, false, _QF_, PRECISION8);
...
*/
	...
	job_id_sc = spatconv_forward_hw(scale3_block0_shortcut_conv2d_param, soc->in, tmp_out, soc, scale2_block0_B_conv2d_size, scale3_block0_shortcut_conv2d_size, scale3_block0_shortcut_conv2d_stride, scale3_block0_shortcut_conv2d_pad, false, _QF_, PRECISION8);
  ...
  spatconv_wait(soc, job_id_sc);
	...
	spatconv_forward_hw(scale3_block0_A_conv2d_param, soc->in, soc->out, soc, scale2_block0_B_conv2d_size, scale3_block0_A_conv2d_size, scale3_block0_A_conv2d_stride, scale3_block0_A_conv2d_pad, true, _QF_, PRECISION8);
...
*/ 
	...
	job_id_sc = spatconv_forward_hw(scale4_block0_shortcut_conv2d_param, soc->in, tmp_out, soc, scale3_block0_B_conv2d_size, scale4_block0_shortcut_conv2d_size, scale4_block0_shortcut_conv2d_stride, scale4_block0_shortcut_conv2d_pad, false, _QF_, PRECISION8);
	...
	spatconv_forward_hw(scale4_block0_A_conv2d_param, soc->in, soc->out, soc, scale3_block0_B_conv2d_size, scale4_block0_A_conv2d_size, scale4_block0_A_conv2d_stride, scale4_block0_A_conv2d_pad, true, _QF_, PRECISION8);
...
*/
	...
	job_id_sc = spatconv_forward_hw(scale5_block0_shortcut_conv2d_param, soc->in, tmp_out, soc, scale4_block0_B_conv2d_size, scale5_block0_shortcut_conv2d_size, scale5_block0_shortcut_conv2d_stride, scale5_block0_shortcut_conv2d_pad, false, _QF_, PRECISION8);
	...
	spatconv_forward_hw(scale5_block0_A_conv2d_param, soc->in, soc->out, soc, scale4_block0_B_conv2d_size, scale5_block0_A_conv2d_size, scale5_block0_A_conv2d_stride, scale5_block0_A_conv2d_pad, true, _QF_, PRECISION8);
