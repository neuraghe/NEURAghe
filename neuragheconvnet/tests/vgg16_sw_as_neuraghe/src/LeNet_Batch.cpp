...
void cnnMainInit(VARNAME load_data_dir)
{
	...
	load_fixed(filename,conv1_1_weights_dim,conv1_1_weights_array);
	...
	load_fixed(filename,conv1_1_bias_dim,conv1_1_bias_array);
	...
	load_fixed(filename,conv1_2_weights_dim,conv1_2_weights_array);
	...
	load_fixed(filename,conv1_2_bias_dim,conv1_2_bias_array);
	...
	load_fixed(filename,conv2_1_weights_dim,conv2_1_weights_array);
	...
	load_fixed(filename,conv2_1_bias_dim,conv2_1_bias_array);
	...
	load_fixed(filename,conv2_2_weights_dim,conv2_2_weights_array);
	...
	load_fixed(filename,conv2_2_bias_dim,conv2_2_bias_array);
	...
	load_fixed(filename,conv3_1_weights_dim,conv3_1_weights_array);
	...
	load_fixed(filename,conv3_1_bias_dim,conv3_1_bias_array);
	...
	load_fixed(filename,conv3_2_weights_dim,conv3_2_weights_array);
	...
	load_fixed(filename,conv3_2_bias_dim,conv3_2_bias_array);
	...
	load_fixed(filename,conv3_3_weights_dim,conv3_3_weights_array);
	...
	load_fixed(filename,conv3_3_bias_dim,conv3_3_bias_array);
	...
	load_fixed(filename,conv4_1_weights_dim,conv4_1_weights_array);
	...
	load_fixed(filename,conv4_1_bias_dim,conv4_1_bias_array);
	...
	load_fixed(filename,conv4_2_weights_dim,conv4_2_weights_array);
	...
	load_fixed(filename,conv4_2_bias_dim,conv4_2_bias_array);
	...
	load_fixed(filename,conv4_3_weights_dim,conv4_3_weights_array);
	...
	load_fixed(filename,conv4_3_bias_dim,conv4_3_bias_array);
	...
	load_fixed(filename,conv5_1_weights_dim,conv5_1_weights_array);
	...
	load_fixed(filename,conv5_1_bias_dim,conv5_1_bias_array);
	...
	load_fixed(filename,conv5_2_weights_dim,conv5_2_weights_array);
	...
	load_fixed(filename,conv5_2_bias_dim,conv5_2_bias_array);
	...
	load_fixed(filename,conv5_3_weights_dim,conv5_3_weights_array);
	...
	load_fixed(filename,conv5_3_bias_dim,conv5_3_bias_array);
...
void cnnMain(DATA* image, float* results)
{
	...
	_tprintf_("CHECKSUM: %lld \n", checksum(conv5_3_output, conv5_3_dim));
	...
	SIZE fc8_dim = 1000;
	static DATA fc8_output[fc8_dim];
	linear_forward(fc8_param, drop7_output, fc8_output, fc7_dim, fc8_dim);
