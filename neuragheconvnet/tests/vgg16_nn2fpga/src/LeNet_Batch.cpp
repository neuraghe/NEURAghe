...
void cnnMain(DATA* image, DATA* results)
{
	...
	spatconv_forward_hw(conv1_1_param, soc->in, soc->out, soc, input_size, conv1_1_size, conv1_1_stride, conv1_1_pad, true);
	...
	soc->in = (DATA*)((uintptr_t)soc->in ^ (uintptr_t)soc->out);
	basicBlock_hw(conv1_2_param, soc->in, soc->out, soc, conv1_1_size, conv1_2_size, conv1_2_stride, conv1_2_pad, POOL_2x2, MAX_POOL, true);
	...
	soc->out = (DATA*)((uintptr_t)soc->out ^ (uintptr_t)soc->in);
	soc->in = (DATA*)((uintptr_t)soc->in ^ (uintptr_t)soc->out);
	spatconv_forward_hw(conv2_1_param, soc->in, soc->out, soc, conv1_2_size, conv2_1_size, conv2_1_stride, conv2_1_pad, true);
	...
	soc->out = (DATA*)((uintptr_t)soc->out ^ (uintptr_t)soc->in);
	soc->in = (DATA*)((uintptr_t)soc->in ^ (uintptr_t)soc->out);
	basicBlock_hw(conv2_2_param, soc->in, soc->out, soc, conv2_1_size, conv2_2_size, conv2_2_stride, conv2_2_pad, POOL_2x2, MAX_POOL, true);
	...
	soc->out = (DATA*)((uintptr_t)soc->out ^ (uintptr_t)soc->in);
	soc->in = (DATA*)((uintptr_t)soc->in ^ (uintptr_t)soc->out);
	spatconv_forward_hw(conv3_1_param, soc->in, soc->out, soc, conv2_2_size, conv3_1_size, conv3_1_stride, conv3_1_pad, true);
	...
	soc->out = (DATA*)((uintptr_t)soc->out ^ (uintptr_t)soc->in);
	soc->in = (DATA*)((uintptr_t)soc->in ^ (uintptr_t)soc->out);
	spatconv_forward_hw(conv3_2_param, soc->in, soc->out, soc, conv3_1_size, conv3_2_size, conv3_2_stride, conv3_2_pad, true);
	...
	soc->out = (DATA*)((uintptr_t)soc->out ^ (uintptr_t)soc->in);
	soc->in = (DATA*)((uintptr_t)soc->in ^ (uintptr_t)soc->out);
	basicBlock_hw(conv3_3_param, soc->in, soc->out, soc, conv3_2_size, conv3_3_size, conv3_3_stride, conv3_3_pad, POOL_2x2, MAX_POOL, true);
	...
	soc->out = (DATA*)((uintptr_t)soc->out ^ (uintptr_t)soc->in);
	soc->in = (DATA*)((uintptr_t)soc->in ^ (uintptr_t)soc->out);
	spatconv_forward_hw(conv4_1_param, soc->in, soc->out, soc, conv3_3_size, conv4_1_size, conv4_1_stride, conv4_1_pad, true);
	...
	soc->out = (DATA*)((uintptr_t)soc->out ^ (uintptr_t)soc->in);
	soc->in = (DATA*)((uintptr_t)soc->in ^ (uintptr_t)soc->out);
	spatconv_forward_hw(conv4_2_param, soc->in, soc->out, soc, conv4_1_size, conv4_2_size, conv4_2_stride, conv4_2_pad, true);
	...
	soc->out = (DATA*)((uintptr_t)soc->out ^ (uintptr_t)soc->in);
	soc->in = (DATA*)((uintptr_t)soc->in ^ (uintptr_t)soc->out);
	basicBlock_hw(conv4_3_param, soc->in, soc->out, soc, conv4_2_size, conv4_3_size, conv4_3_stride, conv4_3_pad, POOL_2x2, MAX_POOL, true);
	...
	soc->out = (DATA*)((uintptr_t)soc->out ^ (uintptr_t)soc->in);
	soc->in = (DATA*)((uintptr_t)soc->in ^ (uintptr_t)soc->out);
	spatconv_forward_hw(conv5_1_param, soc->in, soc->out, soc, conv4_3_size, conv5_1_size, conv5_1_stride, conv5_1_pad, true);
	...
	soc->out = (DATA*)((uintptr_t)soc->out ^ (uintptr_t)soc->in);
	soc->in = (DATA*)((uintptr_t)soc->in ^ (uintptr_t)soc->out);
	spatconv_forward_hw(conv5_2_param, soc->in, soc->out, soc, conv5_1_size, conv5_2_size, conv5_2_stride, conv5_2_pad, true);
	...
	soc->out = (DATA*)((uintptr_t)soc->out ^ (uintptr_t)soc->in);
	soc->in = (DATA*)((uintptr_t)soc->in ^ (uintptr_t)soc->out);
	basicBlock_hw(conv5_3_param, soc->in, soc->out, soc, conv5_2_size, conv5_3_size, conv5_3_stride, conv5_3_pad, POOL_2x2, MAX_POOL, true);
