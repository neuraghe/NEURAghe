...
void cnnMain(DATA* image, float* results)
{
	...
	spatconv_forward_hw(scale2_block0_A_conv2d_param, soc->in, tmp_out, soc, scale2_max_pool_size, scale2_block0_A_conv2d_size, scale2_block0_A_conv2d_stride, scale2_block0_A_conv2d_pad, true);
...
//	soc->in = (DATA*)((uintptr_t)soc->in ^ (uintptr_t)soc->out);
	...
	job_id = spatconv_forward_hw(scale2_block0_B_conv2d_param, tmp_out, soc->out, soc, scale2_block0_A_conv2d_size, scale2_block0_B_conv2d_size, scale2_block0_B_conv2d_stride, scale2_block0_B_conv2d_pad);
