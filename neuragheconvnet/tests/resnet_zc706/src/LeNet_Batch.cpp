...
*/  
  ...
  round4 (soc->in, scale1_conv2d_padding_output, 5, 3, 226, 226);
    ...
    #pragma omp parallel shared(conv_id)
    {
	    ...
	    //	        memcpyNEON(scale1_conv2d_5x5_0_output, scale1_conv2d_5x5_0_out, scale1_conv2d_5x5_out_dim*sizeof(DATA));
	  ...
	  //  		memcpyNEON(scale1_conv2d_5x5_1_output, scale1_conv2d_5x5_1_out, scale1_conv2d_5x5_out_dim*sizeof(DATA));
	  ...
	  //  		memcpyNEON(scale1_conv2d_5x5_2_output, scale1_conv2d_5x5_2_out, scale1_conv2d_5x5_out_dim*sizeof(DATA));
	 ...
	 //   		memcpyNEON(scale1_conv2d_5x5_3_output, scale1_conv2d_5x5_3_out, scale1_conv2d_5x5_out_dim*sizeof(DATA));
...
// OK 2x2 4x4
	...
	/*
 if (_NCOL_== 2)
    print_data(soc->out, 256*14*14, "./y2x2.txt");
  else
    print_data(soc->out, 256*14*14, "./y4x4.txt");
