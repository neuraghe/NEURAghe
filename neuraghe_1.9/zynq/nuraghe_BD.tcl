...
################################################################
# This is a generated script based on design: nuraghe_BD
#
...
CONFIG.MMCM_COMPENSATION.VALUE_SRC {DEFAULT} \
  ...
  # Create instance: nurageh_soc_0, and set properties
  set nurageh_soc_0 [ create_bd_cell -type ip -vlnv uniCA:user:nuraghe_soc:1.0 nurageh_soc_0 ]
...
CONFIG.C_S00_AXI_ID_WIDTH {12} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins nurageh_soc_0/DATA_IN_S] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ulpsoc_0_DATA_OUT_M [get_bd_intf_pins axi_protocol_converter_0/S_AXI] [get_bd_intf_pins nurageh_soc_0/DATA_OUT_M]
  connect_bd_intf_net -intf_net ulpsoc_0_STDOUT_M [get_bd_intf_pins axi_protocol_converter_1/S_AXI] [get_bd_intf_pins nurageh_soc_0/STDOUT_M]

  # Create port connections
  connect_bd_net -net clk_wiz_1_clk_out2 [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins nurageh_soc_0/clk_cluster_fast_i]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins rst_processing_system7_0_50M/dcm_locked]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dwidth_converter_0/s_axi_aclk] [get_bd_pins axi_protocol_converter_0/aclk] [get_bd_pins axi_protocol_converter_1/aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins nurageh_soc_0/clk_soc_i] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_50M/slowest_sync_clk] [get_bd_pins soc_AXI_ctrl_v1_0_0/s00_axi_aclk]
  ...
  connect_bd_net -net rst_processing_system7_0_50M_peripheral_aresetn [get_bd_pins axi_dwidth_converter_0/s_axi_aresetn] [get_bd_pins axi_protocol_converter_0/aresetn] [get_bd_pins axi_protocol_converter_1/aresetn] [get_bd_pins nurageh_soc_0/rstn_sync_i] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_50M/peripheral_aresetn] [get_bd_pins soc_AXI_ctrl_v1_0_0/s00_axi_aresetn]
  connect_bd_net -net soc_AXI_ctrl_v1_0_0_fech_enable_o [get_bd_ports fech_enable_o] [get_bd_pins nurageh_soc_0/fetch_en_i] [get_bd_pins soc_AXI_ctrl_v1_0_0/fech_enable_o]
  connect_bd_net -net soc_AXI_ctrl_v1_0_0_mode_select_o [get_bd_pins nurageh_soc_0/mode_select_i] [get_bd_pins soc_AXI_ctrl_v1_0_0/mode_select_o]
  connect_bd_net -net soc_AXI_ctrl_v1_0_0_test_mode_o [get_bd_pins nurageh_soc_0/test_mode_i] [get_bd_pins soc_AXI_ctrl_v1_0_0/test_mode_o]
  connect_bd_net -net ulpsoc_0_eoc_o [get_bd_pins nurageh_soc_0/eoc_o] [get_bd_pins soc_AXI_ctrl_v1_0_0/eoc_i]
  connect_bd_net -net ulpsoc_0_return_o [get_bd_pins nurageh_soc_0/return_o] [get_bd_pins soc_AXI_ctrl_v1_0_0/return_i]
  ...
  create_bd_addr_seg -range 0x10000000 -offset 0x50000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs nurageh_soc_0/DATA_IN_S/Reg] SEG_ulpsoc_0_Reg

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   comment_0: "Zynq interconnect for NURAGHE IP",
   comment_1: "To change operating frequency, act on clock wizard block.
NURAGHE IP needs two clock:
> one faster for the HW concolution engine
> one slower for the whole system",
...
preplace inst rst_processing_system7_0_50M -pg 1 -lvl 2 -y 180 -defaultsOSRD
preplace inst nurageh_soc_0 -pg 1 -lvl 4 -y 220 -defaultsOSRD
...
preplace netloc ulpsoc_0_eoc_o 1 3 2 920 340 1230
preplace netloc rst_processing_system7_0_50M_interconnect_aresetn 1 2 1 540
preplace netloc processing_system7_0_M_AXI_GP0 1 2 6 550 10 NJ 10 NJ 10 NJ 10 NJ 10 2270
preplace netloc soc_AXI_ctrl_v1_0_0_test_mode_o 1 3 2 920 110 1240
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 8 20 150 180 270 NJ 360 NJ 360 NJ 360 NJ 360 NJ 360 2260
preplace netloc rst_processing_system7_0_50M_peripheral_aresetn 1 2 4 570 310 890 100 1260 160 1550
preplace netloc axi_protocol_converter_0_M_AXI 1 6 1 1860
preplace netloc ulpsoc_0_STDOUT_M 1 4 1 1270
preplace netloc processing_system7_0_FIXED_IO 1 7 1 NJ
preplace netloc soc_AXI_ctrl_v1_0_0_fech_enable_o 1 3 5 910 370 1270 370 NJ 370 NJ 370 NJ
preplace netloc clk_wiz_1_locked 1 1 1 N
preplace netloc ulpsoc_0_DATA_OUT_M 1 4 2 N 210 NJ
preplace netloc clk_wiz_1_clk_out2 1 1 3 190 80 NJ 290 NJ
preplace netloc axi_dwidth_converter_0_M_AXI 1 6 1 1860
preplace netloc processing_system7_0_FCLK_CLK0 1 1 6 200 90 560 300 880 70 1260 20 1540 180 1850
preplace netloc soc_AXI_ctrl_v1_0_0_mode_select_o 1 3 2 910 80 1250
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 3 1 N
preplace netloc axi_protocol_converter_1_M_AXI 1 5 1 1530
preplace netloc ulpsoc_0_return_o 1 3 2 900 330 1220
preplace netloc processing_system7_0_FCLK_CLK2 1 0 8 20 350 NJ 350 NJ 350 NJ 350 NJ 350 NJ 350 NJ 350 2270
preplace cgraphic comment_1 place abs 23 380 textcolor 4 linecolor 3 linewidth 2
preplace cgraphic comment_0 place abs 470 -102 textcolor 4 linecolor 3 linewidth 0
levelinfo -pg 1 0 100 370 720 1080 1400 1700 2060 2290 -top 0 -bot 550
",
}
