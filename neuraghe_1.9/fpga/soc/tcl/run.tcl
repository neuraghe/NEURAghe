...
#read_ip $FPGA_IPS/xilinx_tcdm_bank_1024x64/ip/xilinx_tcdm_bank_1024x64.xci
#read_ip $FPGA_IPS/xilinx_tcdm_bank_4096x64/ip/xilinx_tcdm_bank_4096x64.xci
...
rename_ref -prefix_all POST_SYNTH_

write_edif -force ulpsoc.edf
write_verilog -mode synth_stub -force ulpsoc_stub.v

write_verilog -mode funcsim -force ulpsoc_funcsim.v
