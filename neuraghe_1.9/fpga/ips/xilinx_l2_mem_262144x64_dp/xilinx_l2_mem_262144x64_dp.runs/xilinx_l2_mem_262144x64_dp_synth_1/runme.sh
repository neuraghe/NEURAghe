...
HD_PWD='/home/gderiu/xilinx_l2_mem_262144x64_dp/xilinx_l2_mem_262144x64_dp.runs/xilinx_l2_mem_262144x64_dp_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xilinx_l2_mem_262144x64_dp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xilinx_l2_mem_262144x64_dp.tcl
