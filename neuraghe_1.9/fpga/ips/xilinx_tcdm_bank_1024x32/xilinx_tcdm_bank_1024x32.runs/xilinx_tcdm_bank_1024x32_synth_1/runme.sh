...
HD_PWD='/home/gderiu/neuraghe_wei2ddr/fpga/ips/xilinx_tcdm_bank_1024x32/xilinx_tcdm_bank_1024x32.runs/xilinx_tcdm_bank_1024x32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xilinx_tcdm_bank_1024x32.vds -m64 -mode batch -messageDb vivado.pb -notrace -source xilinx_tcdm_bank_1024x32.tcl
