...
________________________________________________________________________________________________
       ...
       Ring Width         :  2                                                 
       Bus Format         :  1                                                 
       Memaker Path       :  /home/techlibs/faraday/memaker/201301.1.1/memlib  
       GUI Version        :  m20100910                                         
       Date               :  2015/03/11 15:55:51                               
________________________________________________________________________________________________
...
module SHKA65_1024X8X4CM8 (A,DO,DI,DVSE,DVS,WEB,CK,CSB);
  ...
  parameter  TOH                  = (25.8:41.8:76.4); 
  parameter  TWDX                 = (38.8:62.7:114.6);
...
/* -----\/----- EXCLUDED -----\/-----
   specify
      specparam TAA  = (65.6:107.4:198.9);
      specparam TWDV = (65.6:107.4:198.9);
      specparam TRC  = (77.5:125.3:229.2);
      specparam THPW = (9.9:14.8:24.7);
      specparam TLPW = (9.9:14.8:24.7);
      specparam TAS  = (4.5:7.1:12.5);
      specparam TAH  = (11.0:16.1:26.8);
      specparam TWS  = (9.1:13.7:25.7);
      specparam TWH  = (13.2:20.0:34.1);
      specparam TDS  = (10.0:10.0:11.1);
      specparam TDH  = (17.9:26.6:46.9);
      specparam TCSS = (14.8:22.9:39.8);
      specparam TCSH = (15.8:23.7:41.1);
