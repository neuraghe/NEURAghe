...
________________________________________________________________________________________________
        ...
        Synchronous  High Density Single Port SRAM Compiler With Row Redundancy
...
________________________________________________________________________________________________
        ...
        Copyright (C) 2014 Faraday Technology Corporation. All Rights Reserved.       
...
________________________________________________________________________________________________
       ...
       Ring Width         :  5                                                          
       Bus Format         :  1                                                          
       Memaker Path       :  /usr/pack/umc-65-kgf/faraday/ll/memaker/201301.1.1/memlib  
       GUI Version        :  m20100910                                                  
       Date               :  2014/10/23 17:46:44                                        
________________________________________________________________________________________________
...
module SHKA65_8192X8X4CM16 (A,DO,DI,DVSE,DVS,WEB,CK,CSB);
  ...
  parameter  TOH                  = (41.2:67.8:126.9);
  parameter  TWDX                 = (61.8:101.8:190.4);
...
`protect
  reg        [Bytes-1:0][Bits-1:0]     Mem          [Words-1:0];
  integer    index;
  ...
  begin
    ...
    begin
        Memory_byte0[index] = Mem[index][0];
        Memory_byte1[index] = Mem[index][1];
        Memory_byte2[index] = Mem[index][2];
        Memory_byte3[index] = Mem[index][3];
    end
  end
...
/* -----\/----- EXCLUDED -----\/-----
   specify
      specparam TAA  = (110.7:183.8:345.1);
      specparam TWDV = (110.7:183.8:345.1);
      specparam TRC  = (123.7:203.5:380.7);
      specparam THPW = (9.9:14.8:24.7);
      specparam TLPW = (9.9:14.8:24.7);
      specparam TAS  = (4.9:8.1:14.9);
      specparam TAH  = (11.0:16.1:26.8);
      specparam TWS  = (8.2:12.4:25.8);
      specparam TWH  = (13.4:20.4:34.5);
      specparam TDS  = (10.0:10.0:10.0);
      specparam TDH  = (19.6:29.1:50.8);
      specparam TCSS = (17.0:25.9:44.4);
      specparam TCSH = (16.4:24.9:43.1);
