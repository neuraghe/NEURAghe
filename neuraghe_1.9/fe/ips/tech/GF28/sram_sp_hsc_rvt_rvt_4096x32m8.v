...
//
//       Instance Name:              sram_sp_hsc_rvt_rvt_4096x32m8
//       Words:                      4096
//       Bits:                       32
//       Mux:                        8
//       Drive:                      6
...
//       
//       Creation Date:  Wed Oct 21 17:09:46 2015
//       Version: 	r5p1
//
...
module datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 (CLK,Q_update,D_update,SE,SI,D,DFTRAMBYP,mem_path,XQ,Q);
...
endmodule // datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8
...
`ifdef POWER_PINS
module sram_sp_hsc_rvt_rvt_4096x32m8 (VDDCE, VDDPE, VSSE, CENY, WENY, AY, GWENY, Q,
    SO, CLK, CEN, WEN, A, D, EMA, EMAW, EMAS, TEN, TCEN, TWEN, TA, TD, GWEN, TGWEN,
    RET1N, SI, SE, DFTRAMBYP);
`else
module sram_sp_hsc_rvt_rvt_4096x32m8 (CENY, WENY, AY, GWENY, Q, SO, CLK, CEN, WEN,
...
`endif
  ...
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ0 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(SI_int[0]), .D(D_int_bmux[0]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[0]), .XQ(XQ), .Q(Q_int[0]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ1 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[0]), .D(D_int_bmux[1]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[1]), .XQ(XQ), .Q(Q_int[1]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ2 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[1]), .D(D_int_bmux[2]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[2]), .XQ(XQ), .Q(Q_int[2]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ3 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[2]), .D(D_int_bmux[3]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[3]), .XQ(XQ), .Q(Q_int[3]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ4 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[3]), .D(D_int_bmux[4]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[4]), .XQ(XQ), .Q(Q_int[4]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ5 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[4]), .D(D_int_bmux[5]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[5]), .XQ(XQ), .Q(Q_int[5]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ6 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[5]), .D(D_int_bmux[6]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[6]), .XQ(XQ), .Q(Q_int[6]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ7 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[6]), .D(D_int_bmux[7]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[7]), .XQ(XQ), .Q(Q_int[7]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ8 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[7]), .D(D_int_bmux[8]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[8]), .XQ(XQ), .Q(Q_int[8]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ9 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[8]), .D(D_int_bmux[9]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[9]), .XQ(XQ), .Q(Q_int[9]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ10 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[9]), .D(D_int_bmux[10]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[10]), .XQ(XQ), .Q(Q_int[10]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ11 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[10]), .D(D_int_bmux[11]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[11]), .XQ(XQ), .Q(Q_int[11]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ12 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[11]), .D(D_int_bmux[12]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[12]), .XQ(XQ), .Q(Q_int[12]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ13 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[12]), .D(D_int_bmux[13]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[13]), .XQ(XQ), .Q(Q_int[13]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ14 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[13]), .D(D_int_bmux[14]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[14]), .XQ(XQ), .Q(Q_int[14]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ15 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[14]), .D(D_int_bmux[15]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[15]), .XQ(XQ), .Q(Q_int[15]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ16 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[17]), .D(D_int_bmux[16]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[16]), .XQ(XQ), .Q(Q_int[16]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ17 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[18]), .D(D_int_bmux[17]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[17]), .XQ(XQ), .Q(Q_int[17]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ18 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[19]), .D(D_int_bmux[18]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[18]), .XQ(XQ), .Q(Q_int[18]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ19 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[20]), .D(D_int_bmux[19]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[19]), .XQ(XQ), .Q(Q_int[19]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ20 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[21]), .D(D_int_bmux[20]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[20]), .XQ(XQ), .Q(Q_int[20]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ21 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[22]), .D(D_int_bmux[21]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[21]), .XQ(XQ), .Q(Q_int[21]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ22 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[23]), .D(D_int_bmux[22]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[22]), .XQ(XQ), .Q(Q_int[22]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ23 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[24]), .D(D_int_bmux[23]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[23]), .XQ(XQ), .Q(Q_int[23]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ24 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[25]), .D(D_int_bmux[24]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[24]), .XQ(XQ), .Q(Q_int[24]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ25 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[26]), .D(D_int_bmux[25]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[25]), .XQ(XQ), .Q(Q_int[25]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ26 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[27]), .D(D_int_bmux[26]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[26]), .XQ(XQ), .Q(Q_int[26]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ27 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[28]), .D(D_int_bmux[27]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[27]), .XQ(XQ), .Q(Q_int[27]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ28 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[29]), .D(D_int_bmux[28]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[28]), .XQ(XQ), .Q(Q_int[28]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ29 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[30]), .D(D_int_bmux[29]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[29]), .XQ(XQ), .Q(Q_int[29]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ30 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[31]), .D(D_int_bmux[30]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[30]), .XQ(XQ), .Q(Q_int[30]));
  datapath_latch_sram_sp_hsc_rvt_rvt_4096x32m8 uDQ31 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(SI_int[1]), .D(D_int_bmux[31]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[31]), .XQ(XQ), .Q(Q_int[31]));
...
`endif
  ...
  reg NOT_CEN, NOT_WEN3, NOT_WEN2, NOT_WEN1, NOT_WEN0, NOT_A11, NOT_A10, NOT_A9, NOT_A8;
  ...
  reg NOT_D1, NOT_D0, NOT_EMA2, NOT_EMA1, NOT_EMA0, NOT_EMAW1, NOT_EMAW0, NOT_EMAS;
  reg NOT_TEN, NOT_TCEN, NOT_TWEN3, NOT_TWEN2, NOT_TWEN1, NOT_TWEN0, NOT_TA11, NOT_TA10;
  ...
  reg NOT_GWEN, NOT_TGWEN, NOT_SI1, NOT_SI0, NOT_SE, NOT_DFTRAMBYP, NOT_RET1N;
 ...
 wire  CLK_;
  ...
  buf B16(AY[11], AY_[11]);
  buf B17(GWENY, GWENY_);
  buf B18(Q[0], Q_[0]);
  buf B19(Q[1], Q_[1]);
  buf B20(Q[2], Q_[2]);
  buf B21(Q[3], Q_[3]);
  ...
  buf B52(CLK_, CLK);
  buf B53(CEN_, CEN);
  buf B54(WEN_[0], WEN[0]);
  buf B55(WEN_[1], WEN[1]);
  buf B56(WEN_[2], WEN[2]);
  buf B57(WEN_[3], WEN[3]);
  buf B58(A_[0], A[0]);
  buf B59(A_[1], A[1]);
  buf B60(A_[2], A[2]);
  buf B61(A_[3], A[3]);
  ...
  buf B108(TEN_, TEN);
  buf B109(TCEN_, TCEN);
  buf B110(TWEN_[0], TWEN[0]);
  buf B111(TWEN_[1], TWEN[1]);
  buf B112(TWEN_[2], TWEN[2]);
  buf B113(TWEN_[3], TWEN[3]);
  buf B114(TA_[0], TA[0]);
  buf B115(TA_[1], TA[1]);
  buf B116(TA_[2], TA[2]);
  buf B117(TA_[3], TA[3]);
  ...
  buf B122(TA_[8], TA[8]);
  buf B123(TA_[9], TA[9]);
  buf B124(TA_[10], TA[10]);
  buf B125(TA_[11], TA[11]);
  buf B126(TD_[0], TD[0]);
  buf B127(TD_[1], TD[1]);
  buf B128(TD_[2], TD[2]);
  buf B129(TD_[3], TD[3]);
  ...
  buf B134(TD_[8], TD[8]);
  buf B135(TD_[9], TD[9]);
  buf B136(TD_[10], TD[10]);
  buf B137(TD_[11], TD[11]);
  buf B138(TD_[12], TD[12]);
  buf B139(TD_[13], TD[13]);
  buf B140(TD_[14], TD[14]);
  buf B141(TD_[15], TD[15]);
  buf B142(TD_[16], TD[16]);
  buf B143(TD_[17], TD[17]);
  buf B144(TD_[18], TD[18]);
  buf B145(TD_[19], TD[19]);
  buf B146(TD_[20], TD[20]);
  buf B147(TD_[21], TD[21]);
  buf B148(TD_[22], TD[22]);
  buf B149(TD_[23], TD[23]);
  buf B150(TD_[24], TD[24]);
  buf B151(TD_[25], TD[25]);
  buf B152(TD_[26], TD[26]);
  buf B153(TD_[27], TD[27]);
  buf B154(TD_[28], TD[28]);
  buf B155(TD_[29], TD[29]);
  buf B156(TD_[30], TD[30]);
  buf B157(TD_[31], TD[31]);
  buf B158(GWEN_, GWEN);
  buf B159(TGWEN_, TGWEN);
  buf B160(RET1N_, RET1N);
  buf B161(SI_[0], SI[0]);
  buf B162(SI_[1], SI[1]);
  buf B163(SE_, SE);
  buf B164(DFTRAMBYP_, DFTRAMBYP);
...
`endif
 ...
 wire  CLK_;
  ...
  buf B165(CENY, CENY_);
  buf B166(WENY[0], WENY_[0]);
  buf B167(WENY[1], WENY_[1]);
  buf B168(WENY[2], WENY_[2]);
  buf B169(WENY[3], WENY_[3]);
  buf B170(AY[0], AY_[0]);
  buf B171(AY[1], AY_[1]);
  buf B172(AY[2], AY_[2]);
  buf B173(AY[3], AY_[3]);
  ...
  buf B178(AY[8], AY_[8]);
  buf B179(AY[9], AY_[9]);
  buf B180(AY[10], AY_[10]);
  buf B181(AY[11], AY_[11]);
  buf B182(GWENY, GWENY_);
  buf B183(Q[0], Q_[0]);
  buf B184(Q[1], Q_[1]);
  buf B185(Q[2], Q_[2]);
  buf B186(Q[3], Q_[3]);
  ...
  buf B217(CLK_, CLK);
  buf B218(CEN_, CEN);
  buf B219(WEN_[0], WEN[0]);
  buf B220(WEN_[1], WEN[1]);
  buf B221(WEN_[2], WEN[2]);
  buf B222(WEN_[3], WEN[3]);
  buf B223(A_[0], A[0]);
  buf B224(A_[1], A[1]);
  buf B225(A_[2], A[2]);
  buf B226(A_[3], A[3]);
  ...
  buf B273(TEN_, TEN);
  buf B274(TCEN_, TCEN);
  buf B275(TWEN_[0], TWEN[0]);
  buf B276(TWEN_[1], TWEN[1]);
  buf B277(TWEN_[2], TWEN[2]);
  buf B278(TWEN_[3], TWEN[3]);
  buf B279(TA_[0], TA[0]);
  buf B280(TA_[1], TA[1]);
  buf B281(TA_[2], TA[2]);
  buf B282(TA_[3], TA[3]);
  ...
  buf B299(TD_[8], TD[8]);
  buf B300(TD_[9], TD[9]);
  buf B301(TD_[10], TD[10]);
  buf B302(TD_[11], TD[11]);
  buf B303(TD_[12], TD[12]);
  buf B304(TD_[13], TD[13]);
  buf B305(TD_[14], TD[14]);
  buf B306(TD_[15], TD[15]);
  buf B307(TD_[16], TD[16]);
  buf B308(TD_[17], TD[17]);
  buf B309(TD_[18], TD[18]);
  buf B310(TD_[19], TD[19]);
  buf B311(TD_[20], TD[20]);
  buf B312(TD_[21], TD[21]);
  buf B313(TD_[22], TD[22]);
  buf B314(TD_[23], TD[23]);
  buf B315(TD_[24], TD[24]);
  buf B316(TD_[25], TD[25]);
  buf B317(TD_[26], TD[26]);
  buf B318(TD_[27], TD[27]);
  buf B319(TD_[28], TD[28]);
  buf B320(TD_[29], TD[29]);
  buf B321(TD_[30], TD[30]);
  buf B322(TD_[31], TD[31]);
  buf B323(GWEN_, GWEN);
  buf B324(TGWEN_, TGWEN);
  buf B325(RET1N_, RET1N);
  buf B326(SI_[0], SI[0]);
  buf B327(SI_[1], SI[1]);
  buf B328(SE_, SE);
  buf B329(DFTRAMBYP_, DFTRAMBYP);
  ...
  assign GWENY_ = (RET1N_ | pre_charge_st) ? (DFTRAMBYP_ & (TEN_ ? GWEN_ : TGWEN_)) : 1'bx;
   `ifdef ARM_FAULT_MODELING
     sram_sp_hsc_rvt_rvt_4096x32m8_error_injection u1(.CLK(CLK_), .Q_out(Q_), .A(A_int), .CEN(CEN_int), .DFTRAMBYP(DFTRAMBYP_int), .SE(SE_int), .GWEN(GWEN_int), .WEN(WEN_int), .Q_in(Q_int));
  `else
  assign Q_ = (RET1N_ | pre_charge_st) ? ((Q_int)) : {32{1'bx}};
  `endif
  assign SO_ = (RET1N_ | pre_charge_st) ? ({Q_[16], Q_[15]}) : {2{1'bx}};
...
`endif
`timescale 1ns/1ps
module sram_sp_hsc_rvt_rvt_4096x32m8_error_injection (Q_out, Q_in, CLK, A, CEN, DFTRAMBYP, SE, WEN, GWEN);
   output [31:0] Q_out;
   input [31:0] Q_in;
   input CLK;
   input [11:0] A;
