...
# compile scm
analyze -library hwce_lib -format sverilog "../../../../common_cells/cluster_clock_gating_cmos028fdsoi.sv"
...
analyze -library hwce_lib -format sverilog "$PROJ_DIR/hwce_muls.sv"
...
analyze -library hwce_lib -format sverilog "$PROJ_DIR/weight_loader_5x5.sv"
...
set pipe_mul $::env(PIPE_MUL)
set pipe_add $::env(PIPE_ADD)
set time_mux $::env(TIME_MUX)
set linebuffer_width $::env(LINEBUFFER_WIDTH)
elaborate hwce_top_wrap -library hwce_lib -parameters FILTER_SIZE=${filter_size},LINEBUFFER_WIDTH=${linebuffer_width},LATCH_LINEBUFFER=1,LATCH_REGFILE=1,LATCH_FIFO=${latch},LINEBUFFER_KIND=1,PIPE_STAGES_MAC=${pipe_mul},PIPE_STAGES_ADD=${pipe_add},TIME_MUX_FACTOR=${time_mux},APPROXIMATION=${approx} > reports/$kind/elaborate.log
...
set_operating_conditions ss28_0.60V_0C
...
# multicycle/false paths/clock gating false path
set_false_path -through u_hwce_top/u_clk_gating
...
set_false_path -from u_hwce_top/weight_loader_5x5_gen.u_weight_loader/u_weight_latch/MemContent*
set_multicycle_path 2 -setup -from u_hwce_top/u_engine/u_linebuffer/u_fifo_latch/MemContent*
set_multicycle_path 2 -setup -from u_hwce_top/u_engine/u_linebuffer/u_fifo_end_latch/MemContent*
set_multicycle_path 2 -setup -from u_hwce_top/weight_loader_5x5_gen.u_weight_loader/u_weight_latch/ReadData*
set_multicycle_path 2 -setup -from u_hwce_top/u_engine/u_linebuffer/u_fifo_latch/ReadData_a*
set_multicycle_path 2 -setup -from u_hwce_top/u_engine/u_linebuffer/u_fifo_latch/ReadData_b*
set_multicycle_path 2 -setup -from u_hwce_top/u_engine/u_linebuffer/u_fifo_end_latch/ReadData_a*
set_multicycle_path 2 -setup -from u_hwce_top/u_engine/u_linebuffer/u_fifo_end_latch/ReadData_b*
set_multicycle_path 1 -hold -from u_hwce_top/u_wrapper/u_slave/u_regfile/regfile_latch_gen.u_regfile_latch/ReadData*
set_multicycle_path 1 -hold -from u_hwce_top/weight_loader_5x5_gen.u_weight_loader/u_weight_latch/ReadData*
set_multicycle_path 1 -hold -from u_hwce_top/u_engine/u_linebuffer/u_fifo_latch/ReadData_a*
set_multicycle_path 1 -hold -from u_hwce_top/u_engine/u_linebuffer/u_fifo_latch/ReadData_b*
set_multicycle_path 1 -hold -from u_hwce_top/u_engine/u_linebuffer/u_fifo_end_latch/ReadData_a*
set_multicycle_path 1 -hold -from u_hwce_top/u_engine/u_linebuffer/u_fifo_end_latch/ReadData_b*
set_multicycle_path 2 -from u_hwce_top/u_engine/u_linebuffer/u_fifo_latch/WDataIntxD_reg*
set_multicycle_path 2 -from u_hwce_top/u_engine/u_linebuffer/u_fifo_end_latch/WDataIntxD_reg*
set_multicycle_path 2 -from u_hwce_top/u_wrapper/u_slave/u_regfile/regfile_latch_gen.u_regfile_latch/WDataIntxD_reg*
set_multicycle_path 2 -from u_hwce_top/weight_loader_5x5_gen.u_weight_loader/u_weight_latch/WDataIntxD_reg*
...
# set_optimize_registers -designs [get_designs hwce_mac*]       -async_transform multiclass true 
# set_optimize_registers -designs [get_designs hwce_addertree*] -async_transform multiclass true
...
write_file -format verilog -hierarchy -output netlist/$kind/hwce_top_UNMAPPED.v
write_file -format svsim   -hierarchy -output netlist/$kind/hwce_top_UNMAPPED.sv
write_file -format ddc     -hierarchy -output netlist/$kind/hwce_top_UNMAPPED.ddc
