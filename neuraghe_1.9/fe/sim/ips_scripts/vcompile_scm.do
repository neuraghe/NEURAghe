...
vlog -work scm_lib -quiet -sv ${IPS_PATH}/scm/generic_scm/register_file_1w_multi_port_read.sv        || exit 1
vlog -work scm_lib -quiet -sv ${IPS_PATH}/scm/generic_scm/register_file_1w_multi_port_read_be.sv     || exit 1
