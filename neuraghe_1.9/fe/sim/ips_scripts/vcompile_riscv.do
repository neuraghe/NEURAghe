...
vlog -quiet -sv -work ${IP}_lib +incdir+${IPS_PATH}/${IP}/include ${IPS_PATH}/${IP}/prefetch_L0_buffer.sv     || goto error
...
vlog -quiet +define+$1 -sv -work ${IP}_lib +incdir+${IPS_PATH}/${IP}/include ${IPS_PATH}/${IP}/cs_registers.sv           || goto error
