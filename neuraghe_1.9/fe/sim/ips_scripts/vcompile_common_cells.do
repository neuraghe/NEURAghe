...
vlog -sv -work pulp_common_cells_lib -quiet ${IPS_PATH}/common_cells/pulp_sync_wedge.sv
vlog -sv -work pulp_common_cells_lib +define+$1 -quiet ${IPS_PATH}/common_cells/rstgen.sv

vlog -sv -work pulp_common_cells_lib -quiet ${IPS_PATH}/common_cells/generic_fifo.sv

vlog -sv -work pulp_common_cells_lib -quiet ${IPS_PATH}/common_cells/generic_LFSR_8bit.sv
vlog -sv -work pulp_common_cells_lib -quiet ${IPS_PATH}/common_cells/onehot_to_bin.v
