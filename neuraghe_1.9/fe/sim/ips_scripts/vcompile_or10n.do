...
vlog -quiet +define+$1 -sv -work or10n_lib +incdir+${IPS_PATH}/or10n/include ${IPS_PATH}/or10n/id_stage.sv             || exit 1
...
vlog -quiet +define+$1 -sv -work or10n_lib +incdir+${IPS_PATH}/or10n/include ${IPS_PATH}/or10n/controller.sv           || exit 1
...
vlog -quiet +define+$1 -sv -work or10n_lib +incdir+${IPS_PATH}/or10n/include ${IPS_PATH}/or10n/sp_registers.sv         || exit 1
vlog -quiet +define+$1 -sv -work or10n_lib +incdir+${IPS_PATH}/or10n/include ${IPS_PATH}/or10n/or10n_core.sv           || exit 1
